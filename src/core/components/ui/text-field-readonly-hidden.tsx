...
const TextFieldReadOnlyHidden = ({
  ...
  return (
    <div className='w-full flex-col gap-1 hidden'>
      <label
        htmlFor={inputName}
      ...
      <div className='flex items-stretch'>
        ...
        <input
          ...
          value={value}
          onChange={() => { }}
          className={`input input-bordered input-md w-full rounded dark:placeholder:text-gray-600 focus:outline-none ${className
...
export default TextFieldReadOnlyHidden
